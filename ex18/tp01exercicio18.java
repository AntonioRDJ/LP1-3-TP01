...
public class tp01exercicio18 {
    public static void main(String[] args) {
        ...
        System.out.print("Dgite o valor do produto 2: ");
        double p2 = sc.nextDouble();
		
        System.out.print("Dgite o valor do produto 3: ");
        double p3 = sc.nextDouble();
		
        System.out.print("Dgite o valor do produto 4: ");
        double p4 = sc.nextDouble();
		
        System.out.print("Dgite o valor do produto 5: ");
